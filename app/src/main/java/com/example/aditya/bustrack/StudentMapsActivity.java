            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.eta:
                        ...
                        GeoFire geoFire = new GeoFire(reference);
                        System.out.println(mLastKnownLocation.getLatitude() + " LOCATION " + mLastKnownLocation.getLongitude());

                        //This is student's location
                        geoFire.setLocation(uid, new GeoLocation(mLastKnownLocation.getLatitude(), mLastKnownLocation.getLongitude()));

//                         getDriverLocation();


                        //Retreve the darivers location and display
//                        geoFire.setLocation(uid, new GeoLocation(mLastKnownLocation.getLatitude(), mLastKnownLocation.getLongitude()));// This is how you display
